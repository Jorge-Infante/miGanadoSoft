"""
Django settings for miGanadoSoft project.
...
SECRET_KEY = 'django-insecure-s9li+$7nj=^qknxib7d_cu+-7(sqhv!r&qik!l%h43y&jlw=+9'
...
WSGI_APPLICATION = 'miGanadoSoft.wsgi.application'
